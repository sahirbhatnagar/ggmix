...
{\centering \includegraphics[width=1\linewidth]{figure/plot-structure-pc-sim-1} 

}

\caption[Empirical kinship matrices used in simulation studies]{Empirical kinship matrices used in simulation studies.}\label{fig:plot-structure-pc-sim}
\end{figure}
