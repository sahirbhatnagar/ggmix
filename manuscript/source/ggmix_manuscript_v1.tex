...
\caption[Mean $\pm 1$ standard deviation of root mean squared error vs]{Mean $\pm 1$ standard deviation of root mean squared error vs. number of active variables used by each method on the GAW20 data. Diamonds represent median number of active variables and the corresponding root mean square error. Horizontal solid lines span from median to the 90th percentile; Horizontal dotted lines span from the 90th percentile to the 95th percentile.}\label{fig:GAW20-prediction-RMSE-activeVariable}
\end{figure}
...
\caption[Boxplots of the correct sparsity from 200 replications by the true heritability $\eta = \lbrace 10\%, 30\% \rbrace$]{Boxplots of the correct sparsity from 200 replications by the true heritability $\eta = \lbrace 10\%, 30\% \rbrace$.}\label{fig:plot-correct-sparsity-sim-null-model}
\end{figure}
...
{\centering \includegraphics[width=1\linewidth]{figure/plot-estimation-error-sim-null-model-1} 

}

\caption[Boxplots of the estimation error from 200 replications by the true heritability $\eta = \lbrace 10\%, 30\% \rbrace$]{Boxplots of the estimation error from 200 replications by the true heritability $\eta = \lbrace 10\%, 30\% \rbrace$.}\label{fig:plot-estimation-error-sim-null-model}
\end{figure}
...
\caption[Root mean squared prediction error on the test set vs number of active variables from 200 replications by the true heritability $\eta = \lbrace 10\%, 30\% \rbrace$]{Root mean squared prediction error on the test set vs number of active variables from 200 replications by the true heritability $\eta = \lbrace 10\%, 30\% \rbrace$.}\label{fig:plot-mse-nactive-sim-null}
\end{figure}
...
\caption[Means $\pm 1$ standard deviation of true positive rate vs]{Means $\pm 1$ standard deviation of true positive rate vs. false positive rate from 200 replications by the true heritability $\eta = \lbrace 10\%, 30\% \rbrace$.}\label{fig:plot-tpr-fpr-sim-null-model}
\end{figure}
...
\caption[Boxplots of the heritability estimate $\hat{\eta}$ from 200 simulations by the true heritability $\eta = \lbrace 10\%, 30\% \rbrace$]{Boxplots of the heritability estimate $\hat{\eta}$ from 200 simulations by the true heritability $\eta = \lbrace 10\%, 30\% \rbrace$.}\label{fig:plot-eta-sim-null-model}
\end{figure}
...
\caption[Boxplots of the estimated error variance from 200 replications by the true heritability $\eta = \lbrace 10\%, 30\% \rbrace$]{Boxplots of the estimated error variance from 200 replications by the true heritability $\eta = \lbrace 10\%, 30\% \rbrace$.}\label{fig:plot-errorvar-sim-null-model}
\end{figure}
...
\caption[Run time (in log seconds) for null model for \texttt{twostep}, \texttt{lasso} and \texttt{ggmix}]{Run time (in log seconds) for null model for \texttt{twostep}, \texttt{lasso} and \texttt{ggmix}.}\label{fig:plot-runtime-sim-null-model}
\end{figure}
...
\caption[Boxplots of the correct sparsity from 200 replications by the true heritability $\eta = \lbrace 10\%, 30\% \rbrace$ and number of causal SNPs that were included in the calculation of the kinship matrix for the model with 1\% causal SNPs ($c=0.01$)]{Boxplots of the correct sparsity from 200 replications by the true heritability $\eta = \lbrace 10\%, 30\% \rbrace$ and number of causal SNPs that were included in the calculation of the kinship matrix for the model with 1\% causal SNPs ($c=0.01$).}\label{fig:plot-correct-sparsity-sim-1p-causal}
\end{figure}
...
{\centering \includegraphics[width=1\linewidth]{figure/plot-estimation-error-sim-1p-causal-1} 

}

\caption[Boxplots of the estimation error from 200 replications by the true heritability $\eta = \lbrace 10\%, 30\% \rbrace$ and number of causal SNPs that were included in the calculation of the kinship matrix for the model with 1\% causal SNPs ($c=0.01$)]{Boxplots of the estimation error from 200 replications by the true heritability $\eta = \lbrace 10\%, 30\% \rbrace$ and number of causal SNPs that were included in the calculation of the kinship matrix for the model with 1\% causal SNPs ($c=0.01$).}\label{fig:plot-estimation-error-sim-1p-causal}
\end{figure}
...
\caption[Means $\pm 1$ standard deviation of true positive rate vs]{Means $\pm 1$ standard deviation of true positive rate vs. false positive rate from 200 replications by the true heritability $\eta = \lbrace 10\%, 30\% \rbrace$ and number of causal SNPs that were included in the calculation of the kinship matrix for the model with 1\% causal SNPs ($c=0.01$).}\label{fig:plot-tpr-fpr-sim-1p-causal}
\end{figure}
...
\caption[Boxplots of the heritability estimate $\hat{\eta}$ from 200 replications by the true heritability $\eta = \lbrace 10\%, 30\% \rbrace$ and number of causal SNPs that were included in the calculation of the kinship matrix for the model with 1\% causal SNPs ($c=0.01$)]{Boxplots of the heritability estimate $\hat{\eta}$ from 200 replications by the true heritability $\eta = \lbrace 10\%, 30\% \rbrace$ and number of causal SNPs that were included in the calculation of the kinship matrix for the model with 1\% causal SNPs ($c=0.01$).}\label{fig:plot-eta-sim-1p-causal}
\end{figure}
...
\caption[Boxplots of the estimated error variance from 200 replications by the true heritability $\eta = \lbrace 10\%, 30\% \rbrace$ and number of causal SNPs that were included in the calculation of the kinship matrix for the model with 1\% causal SNPs ($c=0.01$)]{Boxplots of the estimated error variance from 200 replications by the true heritability $\eta = \lbrace 10\%, 30\% \rbrace$ and number of causal SNPs that were included in the calculation of the kinship matrix for the model with 1\% causal SNPs ($c=0.01$).}\label{fig:plot-errorvar-sim-1p-causal}
\end{figure}
...
\caption[Root mean squared prediction error on the test set vs]{Root mean squared prediction error on the test set vs. the number of active variables from 200 replications by the true heritability $\eta = \lbrace 10\%, 30\% \rbrace$ and number of causal SNPs that were included in the calculation of the kinship matrix for the model with 1\% causal SNPs ($c=0.01$).}\label{fig:plot-mse-nactive-sim-1p-causal}
\end{figure}
...
\caption[Mean squared error vs number of active variables results from 200 replications by the true heritability $\eta = \lbrace 10\%, 30\% \rbrace$ and number of causal SNPs that were included in the calculation of the kinship matrix for the model with 1\% causal SNPs ($c=0.01$), for 1\% causal SNPs for \texttt{ggmix} and \texttt{lasso} only]{Mean squared error vs number of active variables results from 200 replications by the true heritability $\eta = \lbrace 10\%, 30\% \rbrace$ and number of causal SNPs that were included in the calculation of the kinship matrix for the model with 1\% causal SNPs ($c=0.01$), for 1\% causal SNPs for \texttt{ggmix} and \texttt{lasso} only.}\label{fig:plot-mse-nactive-sim-1p-causal-zoom-in}
\end{figure}
...
\caption[Run time (in log seconds) from 200 replications by the true heritability $\eta = \lbrace 10\%, 30\% \rbrace$ and number of causal SNPs that were included in the calculation of the kinship matrix for the model with 1\% causal SNPs ($c=0.01$)]{Run time (in log seconds) from 200 replications by the true heritability $\eta = \lbrace 10\%, 30\% \rbrace$ and number of causal SNPs that were included in the calculation of the kinship matrix for the model with 1\% causal SNPs ($c=0.01$).}\label{fig:plot-runtime-sim-1p-causal}
\end{figure}
