...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: 'gen\_structured\_model' is not an exported object from 'namespace:ggmix'}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in popkin::plotPopkin(x = list(dat[[1]]\$kin), titles = c("{}Empirical Kinship Matrix with Block Structure"{}), : object 'dat' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in plot(dat[[1]]\$x\_lasso[, 5001], dat[[1]]\$x\_lasso[, 5002], pch = 19, : object 'dat' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in setDT(as.data.frame(x, ...)): Argument 'x' to 'setDT' should be a 'list', 'data.frame' or 'data.table'}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'p1\_nactive' not found}}\end{kframe}
\end{knitrout}
