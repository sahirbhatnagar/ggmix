...
\caption[First two principal component scores of the genotype data used to estimate the kinship matrix where each color represents one of the 3 simulated subpopulations]{First two principal component scores of the genotype data used to estimate the kinship matrix where each color represents one of the 3 simulated subpopulations.}\label{fig:plot-pc-sim}
\end{figure}
...
\caption[Boxplots of the correct sparsity from 200 replications by the true heritability $\eta = \lbrace 10\%, 50\% \rbrace$]{Boxplots of the correct sparsity from 200 replications by the true heritability $\eta = \lbrace 10\%, 50\% \rbrace$.}\label{fig:plot-correct-sparsity-sim-null-model}
\end{figure}
...
\caption[Root mean squared prediction error on the test set vs number of active variables from 200 replications by the true heritability $\eta = \lbrace 10\%, 50\% \rbrace$]{Root mean squared prediction error on the test set vs number of active variables from 200 replications by the true heritability $\eta = \lbrace 10\%, 50\% \rbrace$.}\label{fig:plot-mse-nactive-sim-null}
\end{figure}
...
\caption[Means $\pm 1$ standard deviation of true positive rate vs]{Means $\pm 1$ standard deviation of true positive rate vs. false positive rate from 200 replications by the true heritability $\eta = \lbrace 10\%, 50\% \rbrace$.}\label{fig:plot-tpr-fpr-sim-null-model}
\end{figure}
...
\caption[Boxplots of the heritability estimate $\hat{\eta}$ from 200 simulations by the true heritability $\eta = \lbrace 10\%, 50\% \rbrace$]{Boxplots of the heritability estimate $\hat{\eta}$ from 200 simulations by the true heritability $\eta = \lbrace 10\%, 50\% \rbrace$.}\label{fig:plot-eta-sim-null-model}
\end{figure}
...
\caption[Boxplots of the estimated error variance from 200 replications by the true heritability $\eta = \lbrace 10\%, 50\% \rbrace$]{Boxplots of the estimated error variance from 200 replications by the true heritability $\eta = \lbrace 10\%, 50\% \rbrace$.}\label{fig:plot-errorvar-sim-null-model}
\end{figure}
...
\caption[Boxplots of the correct sparsity from 200 replications by the true heritability $\eta = \lbrace 10\%, 50\% \rbrace$ and number of causal SNPs that were included in the calculation of the kinship matrix for the model with 1\% causal SNPs ($c=0.01$)]{Boxplots of the correct sparsity from 200 replications by the true heritability $\eta = \lbrace 10\%, 50\% \rbrace$ and number of causal SNPs that were included in the calculation of the kinship matrix for the model with 1\% causal SNPs ($c=0.01$).}\label{fig:plot-correct-sparsity-sim-1p-causal}
\end{figure}
...
\caption[Means $\pm 1$ standard deviation of true positive rate vs]{Means $\pm 1$ standard deviation of true positive rate vs. false positive rate from 200 replications by the true heritability $\eta = \lbrace 10\%, 50\% \rbrace$ and number of causal SNPs that were included in the calculation of the kinship matrix for the model with 1\% causal SNPs ($c=0.01$).}\label{fig:plot-tpr-fpr-sim-1p-causal}
\end{figure}
...
\caption[Boxplots of the heritability estimate $\hat{\eta}$ from 200 replications by the true heritability $\eta = \lbrace 10\%, 50\% \rbrace$ and number of causal SNPs that were included in the calculation of the kinship matrix for the model with 1\% causal SNPs ($c=0.01$)]{Boxplots of the heritability estimate $\hat{\eta}$ from 200 replications by the true heritability $\eta = \lbrace 10\%, 50\% \rbrace$ and number of causal SNPs that were included in the calculation of the kinship matrix for the model with 1\% causal SNPs ($c=0.01$).}\label{fig:plot-eta-sim-1p-causal}
\end{figure}
...
\caption[Boxplots of the estimated error variance from 200 replications by the true heritability $\eta = \lbrace 10\%, 50\% \rbrace$ and number of causal SNPs that were included in the calculation of the kinship matrix for the model with 1\% causal SNPs ($c=0.01$)]{Boxplots of the estimated error variance from 200 replications by the true heritability $\eta = \lbrace 10\%, 50\% \rbrace$ and number of causal SNPs that were included in the calculation of the kinship matrix for the model with 1\% causal SNPs ($c=0.01$).}\label{fig:plot-errorvar-sim-1p-causal}
\end{figure}
...
\caption[Root mean squared prediction error on the test set vs]{Root mean squared prediction error on the test set vs. the number of active variables from 200 replications by the true heritability $\eta = \lbrace 10\%, 50\% \rbrace$ and number of causal SNPs that were included in the calculation of the kinship matrix for the model with 1\% causal SNPs ($c=0.01$).}\label{fig:plot-mse-nactive-sim-1p-causal}
\end{figure}
...
\caption[Mean squared error vs number of active variables results from 200 replications by the true heritability $\eta = \lbrace 10\%, 50\% \rbrace$ and number of causal SNPs that were included in the calculation of the kinship matrix for the model with 1\% causal SNPs ($c=0.01$), for 1\% causal SNPs for \texttt{ggmix} and \texttt{lasso} only]{Mean squared error vs number of active variables results from 200 replications by the true heritability $\eta = \lbrace 10\%, 50\% \rbrace$ and number of causal SNPs that were included in the calculation of the kinship matrix for the model with 1\% causal SNPs ($c=0.01$), for 1\% causal SNPs for \texttt{ggmix} and \texttt{lasso} only.}\label{fig:plot-mse-nactive-sim-1p-causal-zoom-in}
\end{figure}
...
\caption[Run time (in log seconds) from 200 replications by the true heritability $\eta = \lbrace 10\%, 50\% \rbrace$ and number of causal SNPs that were included in the calculation of the kinship matrix for the model with 1\% causal SNPs ($c=0.01$)]{Run time (in log seconds) from 200 replications by the true heritability $\eta = \lbrace 10\%, 50\% \rbrace$ and number of causal SNPs that were included in the calculation of the kinship matrix for the model with 1\% causal SNPs ($c=0.01$).}\label{fig:plot-runtime-sim-1p-causal}
\end{figure}
