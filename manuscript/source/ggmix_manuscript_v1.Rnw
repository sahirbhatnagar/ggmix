...
Through simulation studies, we show that existing approaches such as the lasso with a principal component adjustment lead to a large number of false positives.     
