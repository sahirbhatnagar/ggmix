...
<<plot-kinship-sim, fig.pos = 'H', fig.cap="Example of an empirical kinship matrix used in simulation studies. This scenario models a 1D geography with extensive admixture.", eval=finalversion>>=
# need to fixed the gen_structured_function for updated functions. use model_functions make_ADmixed_model to make
# a non-simulator version to replce the gen_structured_function
@
...
<<plot-pc-sim, fig.pos = 'H', fig.cap="First two principal component scores of the genotype data used to estimate the kinship matrix where each color represents one of the 10 simulated subpopulations.", eval=finalversion>>=
@
...
<<UKB-Figure, dev="cairo_pdf", fig.asp=0.8, fig.width=12, fig.height=13, fig.pos = 'H', fig.cap="Model selection and testing in the UK Biobank. (a) Root-mean-square error of three methods on the model selection set with respect to a grid search of penalty factor used on the training set. Model built with ggmix with a kinship estimated from 30,000 randomly selected SNPs had erratic performance, and was not evaluated on the test set. (b) Performance of three methods on the test set with penalty factor optimized on the model selection set.", eval=finalversion>>=
@
...
<<GAW20-prediction-RMSE-activeVariable, dev="cairo_pdf", fig.asp=0.8, fig.width=12, fig.height=11, fig.pos = 'H', fig.cap="Mean $\\pm 1$ standard deviation of root mean squared error vs. number of active variables used by each method on the GAW20 data. Diamonds represent median number of active variables and the corresponding root mean square error. Horizontal solid lines span from median to the 90th percentile; Horizontal dotted lines span from the 90th percentile to the 95th percentile.", eval=finalversion>>=
@
...
<<Mice-comparison-fixTPR, dev="cairo_pdf", fig.asp=0.8, fig.width=20, fig.height=8, fig.pos = 'H', fig.cap="Comparison of model performance on the mouse cross data. Pie charts depict model robustness where grey areas denote bootstrap replicates on which the corresponding model is unable to capture both true positives using any penalty factor, whereas colored areas denote successful replicates. Chromosome-based signals record in how many successful replicates the corresponding loci are picked up by the corresponding optimized model. Red dashed lines delineate significance thresholds.", eval=finalversion>>=
@
...
<<plot-correct-sparsity-sim-null-model, dev="cairo_pdf", fig.asp=0.7, fig.width=12, fig.height=9, fig.pos = 'h', fig.cap="Boxplots of the correct sparsity from 200 replications by the true heritability $\\eta = \\lbrace 10\\%, 30\\% \\rbrace$.", eval=finalversion>>=
@

<<plot-estimation-error-sim-null-model, dev="cairo_pdf", fig.asp=0.7, fig.width=12, fig.height=9, fig.pos = 'h', fig.cap="Boxplots of the estimation error from 200 replications by the true heritability $\\eta = \\lbrace 10\\%, 30\\% \\rbrace$.", eval=finalversion>>=
@

<<plot-mse-nactive-sim-null, dev="cairo_pdf", fig.asp=0.8, fig.width=12, fig.height=11, fig.pos = 'H', fig.cap="Root mean squared prediction error on the test set vs number of active variables from 200 replications by the true heritability $\\eta = \\lbrace 10\\%, 30\\% \\rbrace$.", eval=finalversion>>=
@


<<plot-tpr-fpr-sim-null-model, dev="cairo_pdf", fig.asp=0.8, fig.width=12, fig.heigh=11, fig.pos = 'H', fig.cap="Means $\\pm 1$ standard deviation of true positive rate vs. false positive rate from 200 replications by the true heritability $\\eta = \\lbrace 10\\%, 30\\% \\rbrace$.", eval=finalversion>>=
@


<<plot-eta-sim-null-model, dev="cairo_pdf", fig.asp=0.8, fig.width=12, fig.height=9, fig.pos = 'H', fig.cap="Boxplots of the heritability estimate $\\hat{\\eta}$ from 200 simulations by the true heritability $\\eta = \\lbrace 10\\%, 30\\% \\rbrace$.", eval=finalversion>>=
@

<<plot-errorvar-sim-null-model, dev="cairo_pdf", fig.asp=0.8, fig.width=12, fig.heigh=11, fig.pos = 'H', fig.cap="Boxplots of the estimated error variance from 200 replications by the true heritability $\\eta = \\lbrace 10\\%, 30\\% \\rbrace$.", eval=finalversion>>=
@


<<plot-runtime-sim-null-model, dev="cairo_pdf", fig.asp=0.8, fig.width=12, fig.height=11, fig.pos = 'H', fig.cap="Run time (in log seconds) for null model for \\texttt{twostep}, \\texttt{lasso} and \\texttt{ggmix}.", eval=finalversion>>=
@


%%%%%%%%%%%%%%%%%%%%%% NOT USED%%%%%%%%%%%%%%%%%%%%%%%%%%
<<plot-me-nactive-sim-null, dev="cairo_pdf", fig.asp=0.8, fig.width=12, fig.height=11, fig.pos = 'H', fig.cap="Means $\\pm 1$ standard deviation of the model error vs. the number of active variables by the true heritability $\\eta = \\lbrace 10\\%, 30\\% \\rbrace$ for the null model ($c=0$).", eval=FALSE>>=
@

<<plot-nactive-sim-null-model, dev="cairo_pdf", fig.asp=0.8, fig.width=12, fig.height=11, fig.pos = 'H', fig.cap="Boxplots of the number of active variables from 200 simulations by the true heritability $\\eta = \\lbrace 10\\%, 30\\% \\rbrace$ for the null model ($c=0$).", eval=FALSE>>=
@
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
<<plot-correct-sparsity-sim-1p-causal, dev="cairo_pdf", fig.asp=0.8, fig.width=12, fig.height=11, fig.pos = 'h', fig.cap="Boxplots of the correct sparsity from 200 replications by the true heritability $\\eta = \\lbrace 10\\%, 30\\% \\rbrace$ and number of causal SNPs that were included in the calculation of the kinship matrix for the model with 1\\% causal SNPs ($c=0.01$).", eval=finalversion>>=
@

<<plot-estimation-error-sim-1p-causal, dev="cairo_pdf", fig.asp=0.8, fig.width=12, fig.height=11, fig.pos = 'h', fig.cap="Boxplots of the estimation error from 200 replications by the true heritability $\\eta = \\lbrace 10\\%, 30\\% \\rbrace$ and number of causal SNPs that were included in the calculation of the kinship matrix for the model with 1\\% causal SNPs ($c=0.01$).", eval=finalversion>>=
@

\FloatBarrier

<<plot-tpr-fpr-sim-1p-causal, dev="cairo_pdf", fig.asp=0.8, fig.width=12, fig.heigh=11, fig.pos = 'H', fig.cap="Means $\\pm 1$ standard deviation of true positive rate vs. false positive rate from 200 replications by the true heritability $\\eta = \\lbrace 10\\%, 30\\% \\rbrace$ and number of causal SNPs that were included in the calculation of the kinship matrix for the model with 1\\% causal SNPs ($c=0.01$).", eval=finalversion>>=
@

<<plot-eta-sim-1p-causal, dev="cairo_pdf", fig.asp=0.8, fig.width=12, fig.height=11, fig.pos = 'H', fig.cap="Boxplots of the heritability estimate $\\hat{\\eta}$ from 200 replications by the true heritability $\\eta = \\lbrace 10\\%, 30\\% \\rbrace$ and number of causal SNPs that were included in the calculation of the kinship matrix for the model with 1\\% causal SNPs ($c=0.01$).", eval=finalversion>>=
@

<<plot-errorvar-sim-1p-causal, dev="cairo_pdf", fig.asp=0.8, fig.width=12, fig.heigh=11, fig.pos = 'H', fig.cap="Boxplots of the estimated error variance from 200 replications by the true heritability $\\eta = \\lbrace 10\\%, 30\\% \\rbrace$ and number of causal SNPs that were included in the calculation of the kinship matrix for the model with 1\\% causal SNPs ($c=0.01$).", eval=finalversion>>=
@



<<plot-mse-nactive-sim-1p-causal, dev="cairo_pdf", fig.asp=0.8, fig.width=12, fig.height=11, fig.pos = 'H', fig.cap="Root mean squared prediction error on the test set vs. the number of active variables from 200 replications by the true heritability $\\eta = \\lbrace 10\\%, 30\\% \\rbrace$ and number of causal SNPs that were included in the calculation of the kinship matrix for the model with 1\\% causal SNPs ($c=0.01$).", eval=finalversion>>=
@


<<plot-mse-nactive-sim-1p-causal-zoom-in, dev="cairo_pdf", fig.asp=0.8, fig.width=12, fig.height=11, fig.pos = 'H', fig.cap="Mean squared error vs number of active variables results from 200 replications by the true heritability $\\eta = \\lbrace 10\\%, 30\\% \\rbrace$ and number of causal SNPs that were included in the calculation of the kinship matrix for the model with 1\\% causal SNPs ($c=0.01$), for 1\\% causal SNPs for \\texttt{ggmix} and \\texttt{lasso} only.", eval=finalversion>>=
@




<<plot-runtime-sim-1p-causal, dev="cairo_pdf", fig.asp=0.8, fig.width=12, fig.height=11, fig.pos = 'H', fig.cap="Run time (in log seconds) from 200 replications by the true heritability $\\eta = \\lbrace 10\\%, 30\\% \\rbrace$ and number of causal SNPs that were included in the calculation of the kinship matrix for the model with 1\\% causal SNPs ($c=0.01$).", eval=finalversion>>=
@


%%%%%%%%%%%%%%%%%%%%%%%%%%% NOT USED %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
<<plot-me-nactive-sim-1p-causal, dev="cairo_pdf", fig.asp=0.8, fig.width=12, fig.height=11, fig.pos = 'H', fig.cap="Means $\\pm 1$ standard deviation of the model error vs. the number of active variables by the true heritability $\\eta = \\lbrace 10\\%, 30\\% \\rbrace$ and number of causal SNPs that were included in the calculation of the kinship matrix for the model with 1\\% causal SNPs ($c=0.01$).", eval=FALSE>>=
@

<<plot-nactive-sim-1p-causal, dev="cairo_pdf", fig.asp=0.8, fig.width=12, fig.height=11, fig.pos = 'H', fig.cap="Boxplots of the number of active variables from 200 simulations by the true heritability $\\eta = \\lbrace 10\\%, 30\\% \\rbrace$ and number of causal SNPs that were included in the calculation of the kinship matrix for the model with 1\\% causal SNPs ($c=0.01$).", eval=FALSE>>=
@
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
