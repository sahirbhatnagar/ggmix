...
\section{LD structure among the markers in the GAW20 and the mouse dataset}\label{ap:ldplots}
...
<<table-of-results-for-n-equal-to-k, eval=FALSE>>=
@
 
<<print-sim-table-for-n-equal-to-k, results='asis', eval=FALSE>>=
@
