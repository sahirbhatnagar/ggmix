...
Besides, although we do not have much supporting evidence from other studies, we found several other loci might also be reasonably associated with susceptibility to myobacterial infection, where \ggmix ~provides more information than the other two methods.

<<MethodComparisonMice, dev="cairo_pdf", fig.asp=0.8, fig.width=6, fig.height=13.2, fig.pos = 'H', fig.cap="", eval=finalversion>>=
@
