...
<<plot-pc-sim, fig.pos = 'H', fig.cap="First two principal component scores of the genotype data used to estimate the kinship matrix where each color represents one of the 3 simulated subpopulations.", eval=finalversion>>=
@
...
<<plot-correct-sparsity-sim-null-model, dev="cairo_pdf", fig.asp=0.7, fig.width=12, fig.height=9, fig.pos = 'h', fig.cap="Boxplots of the correct sparsity from 200 replications by the true heritability $\\eta = \\lbrace 10\\%, 50\\% \\rbrace$.", eval=finalversion>>=
@

<<plot-mse-nactive-sim-null, dev="cairo_pdf", fig.asp=0.8, fig.width=12, fig.height=11, fig.pos = 'H', fig.cap="Root mean squared prediction error on the test set vs number of active variables from 200 replications by the true heritability $\\eta = \\lbrace 10\\%, 50\\% \\rbrace$.", eval=finalversion>>=
@


<<plot-tpr-fpr-sim-null-model, dev="cairo_pdf", fig.asp=0.8, fig.width=12, fig.heigh=11, fig.pos = 'H', fig.cap="Means $\\pm 1$ standard deviation of true positive rate vs. false positive rate from 200 replications by the true heritability $\\eta = \\lbrace 10\\%, 50\\% \\rbrace$.", eval=finalversion>>=
@


<<plot-eta-sim-null-model, dev="cairo_pdf", fig.asp=0.8, fig.width=12, fig.height=9, fig.pos = 'H', fig.cap="Boxplots of the heritability estimate $\\hat{\\eta}$ from 200 simulations by the true heritability $\\eta = \\lbrace 10\\%, 50\\% \\rbrace$.", eval=finalversion>>=
@

<<plot-errorvar-sim-null-model, dev="cairo_pdf", fig.asp=0.8, fig.width=12, fig.heigh=11, fig.pos = 'H', fig.cap="Boxplots of the estimated error variance from 200 replications by the true heritability $\\eta = \\lbrace 10\\%, 50\\% \\rbrace$.", eval=finalversion>>=
@
...
%%%%%%%%%%%%%%%%%%%%%% NOT USED%%%%%%%%%%%%%%%%%%%%%%%%%%
<<plot-me-nactive-sim-null, dev="cairo_pdf", fig.asp=0.8, fig.width=12, fig.height=11, fig.pos = 'H', fig.cap="Means $\\pm 1$ standard deviation of the model error vs. the number of active variables by the true heritability $\\eta = \\lbrace 10\\%, 50\\% \\rbrace$ for the null model ($c=0$).", eval=FALSE>>=
@

<<plot-nactive-sim-null-model, dev="cairo_pdf", fig.asp=0.8, fig.width=12, fig.height=11, fig.pos = 'H', fig.cap="Boxplots of the number of active variables from 200 simulations by the true heritability $\\eta = \\lbrace 10\\%, 50\\% \\rbrace$ for the null model ($c=0$).", eval=FALSE>>=
@
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
<<plot-correct-sparsity-sim-1p-causal, dev="cairo_pdf", fig.asp=0.8, fig.width=12, fig.height=11, fig.pos = 'h', fig.cap="Boxplots of the correct sparsity from 200 replications by the true heritability $\\eta = \\lbrace 10\\%, 50\\% \\rbrace$ and number of causal SNPs that were included in the calculation of the kinship matrix for the model with 1\\% causal SNPs ($c=0.01$).", eval=finalversion>>=
@

\FloatBarrier

<<plot-tpr-fpr-sim-1p-causal, dev="cairo_pdf", fig.asp=0.8, fig.width=12, fig.heigh=11, fig.pos = 'H', fig.cap="Means $\\pm 1$ standard deviation of true positive rate vs. false positive rate from 200 replications by the true heritability $\\eta = \\lbrace 10\\%, 50\\% \\rbrace$ and number of causal SNPs that were included in the calculation of the kinship matrix for the model with 1\\% causal SNPs ($c=0.01$).", eval=finalversion>>=
@

<<plot-eta-sim-1p-causal, dev="cairo_pdf", fig.asp=0.8, fig.width=12, fig.height=11, fig.pos = 'H', fig.cap="Boxplots of the heritability estimate $\\hat{\\eta}$ from 200 replications by the true heritability $\\eta = \\lbrace 10\\%, 50\\% \\rbrace$ and number of causal SNPs that were included in the calculation of the kinship matrix for the model with 1\\% causal SNPs ($c=0.01$).", eval=finalversion>>=
@

<<plot-errorvar-sim-1p-causal, dev="cairo_pdf", fig.asp=0.8, fig.width=12, fig.heigh=11, fig.pos = 'H', fig.cap="Boxplots of the estimated error variance from 200 replications by the true heritability $\\eta = \\lbrace 10\\%, 50\\% \\rbrace$ and number of causal SNPs that were included in the calculation of the kinship matrix for the model with 1\\% causal SNPs ($c=0.01$).", eval=finalversion>>=
@



<<plot-mse-nactive-sim-1p-causal, dev="cairo_pdf", fig.asp=0.8, fig.width=12, fig.height=11, fig.pos = 'H', fig.cap="Root mean squared prediction error on the test set vs. the number of active variables from 200 replications by the true heritability $\\eta = \\lbrace 10\\%, 50\\% \\rbrace$ and number of causal SNPs that were included in the calculation of the kinship matrix for the model with 1\\% causal SNPs ($c=0.01$).", eval=finalversion>>=
@


<<plot-mse-nactive-sim-1p-causal-zoom-in, dev="cairo_pdf", fig.asp=0.8, fig.width=12, fig.height=11, fig.pos = 'H', fig.cap="Mean squared error vs number of active variables results from 200 replications by the true heritability $\\eta = \\lbrace 10\\%, 50\\% \\rbrace$ and number of causal SNPs that were included in the calculation of the kinship matrix for the model with 1\\% causal SNPs ($c=0.01$), for 1\\% causal SNPs for \\texttt{ggmix} and \\texttt{lasso} only.", eval=finalversion>>=
@




<<plot-runtime-sim-1p-causal, dev="cairo_pdf", fig.asp=0.8, fig.width=12, fig.height=11, fig.pos = 'H', fig.cap="Run time (in log seconds) from 200 replications by the true heritability $\\eta = \\lbrace 10\\%, 50\\% \\rbrace$ and number of causal SNPs that were included in the calculation of the kinship matrix for the model with 1\\% causal SNPs ($c=0.01$).", eval=finalversion>>=
@
