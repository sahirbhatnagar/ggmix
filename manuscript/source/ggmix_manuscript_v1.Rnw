...
<<plot-kinship-sim, fig.width=11, fig.height=7, fig.pos = 'H', fig.cap="Empirical kinship matrix with block diagnoal structure used in simulation studies. Each block represents a subpopulation. ", eval=FALSE>>=
...
<<plot-pc-sim, fig.width=11, fig.height=6, fig.pos = 'H', fig.cap="First two principal component scores of the block diagonal kinship matrix where each color represents one of the 5 simulated subpopulations.", eval=FALSE>>=
@
